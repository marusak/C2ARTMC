...
\tikzstyle{cloud} = [draw, ellipse,fill=red!20, node distance=3cm,
    minimum height=2em]  
\tikzstyle{data} = [rectangle split, rectangle split parts=2, draw, fill=blue!20, 
    text width=3em, text centered, rounded corners, minimum height = 3em]
\tikzstyle{tblock} = [rectangle, draw, fill=blue!20, 
    text width=3em, text centered, rounded corners]
\tikzstyle{label} = [rectangle, text width=6em, text centered]
\tikzstyle{wblock} = [rectangle, draw, fill=blue!20, text centered, rounded corners]
\tikzstyle{ttblock} = [rectangle, draw, fill=blue!20, 
    text width=5em, text centered, rounded corners]
\tikzstyle{final} = [draw, ellipse,fill=red!20, minimum height=2em]  
