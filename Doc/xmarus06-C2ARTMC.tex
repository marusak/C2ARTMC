...
\abstract[en]{With growing complexity of software programs the need for automated verification grows as well. Reasearch group VeriFIT based on Faculty of Information Technology of Brno University of Technology is involved in reaserch of that area. One of the developed tools is tool ARTMC.
This bachelor's thesis designs and implements compiler of C language fragment into input format of the ARTMC tool. Implemented compiler make work with ARTMC tool much easier, since the input format is not suitable for manual creation.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{ARTMC, prekladač, Python, verifikácia}
\keywords[en]{ARTMC, compiler, Python, verification}
