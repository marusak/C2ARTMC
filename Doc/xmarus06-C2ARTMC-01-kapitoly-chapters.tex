...
VSTUp-: prikaz - vystup - co overi...

diagram vstup->daco->vystup...
...
\begin{tikzpicture}[align=center, node distance = 2cm and 3cm, auto]
    ...
    \node [block, below=of lex] (gen) {Generátor vnútorného kódu};
    \node [block, below=of gen] (opti) {Op\-ti\-ma\-li\-zá\-tor};
    \node [block, below=of sema] (gen_ciel) {Generátor cieľového kódu};
